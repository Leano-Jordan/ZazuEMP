...
The GitHub repository currently associated with the project is:
...
This document records the project's intended ownership position. It is not, by itself, a substitute for a signed assignment, employment agreement, contractor agreement, shareholders' agreement, or other legally binding instrument where one is required.
...
- datasets created specifically for the project
- configuration and deployment material
- project-specific inventions or technical methods
- third-party components and their licences

## Contribution rule

No external contributor should be treated as transferring ownership of their contribution merely because they submit a pull request or commit.
...
This record is an engineering/project-control document, not legal advice. Where ownership, employment, contractor rights, licensing, commercialisation, patents, trade marks, confidentiality or disputes are material, obtain qualified legal review.
