<x-app-layout>
    ...
    <form method="POST" action="{{ route('capabilities.update', $capability) }}" class="space-y-6">
        @csrf
        @method('PUT')
        <section class="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
            <div class="mb-5">
                <h2 class="font-semibold text-slate-950">Capability definition</h2>
                <p class="mt-1 text-sm text-slate-500">This is the reusable business definition. Work-specific quantities and pricing come later.</p>
            </div>
